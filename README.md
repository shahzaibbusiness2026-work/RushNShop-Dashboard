# 🚀 RushNshop AI — TikTok Shop Management & TrueProfit Dashboard

> **RushNshop OS**: An AI-powered, multi-account TikTok Shop management system combining TrueProfit-style financial analytics, pre-listing unit economics calculators, automated customer service helpdesk, and TikTok Ads attribution.
...
- **Data Visualizations**: Recharts (Donut, Bar, Area, Sparklines)
- **Backend**: Next.js Route Handlers (`/api/stores`, `/api/products`, `/api/orders`, `/api/ai/chat`)
